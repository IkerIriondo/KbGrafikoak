...
#define KG_WINDOW_TITLE                     "IKER IRIONDO"
#define KG_WINDOW_WIDTH                     1000
#define KG_WINDOW_HEIGHT                    1000
#define KG_WINDOW_X                         70
#define KG_WINDOW_Y                         70
...
typedef struct mz{                      /*Objektu bat 4x4-ko matrize bat gordeko duena*/
    double matrize[16];                 /*Matrizea*/
    struct mz *next;                    /*Matrizearen hurrengoa*/
} mz;
